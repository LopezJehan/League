...
#   KP <- c(calculate_kp(sum(LEC_filt_player()$kills),
#                                sum(LEC_filt_player()$assists),
#                                sum(LEC_filt_player()$teamkills)),
#           calculate_kp(sum(LEC_filt_champion()$kills),
#                        sum(LEC_filt_champion()$assists),
#                        sum(LEC_filt_champion()$teamkills)),
#           100, 0)
#   
#   KS <- c(calculate_ks(sum(LEC_filt_player()$kills),
#                        sum(LEC_filt_player()$teamkills)),
#           calculate_ks(sum(LEC_filt_champion()$kills),
#                        sum(LEC_filt_champion()$teamkills)),
#           100, 0)
#     
#   AS <- c(calculate_ds(sum(LEC_filt_player()$deaths),
#                        sum(LEC_filt_player()$teamdeaths)),
#           calculate_ds(sum(LEC_filt_champion()$deaths),
#                        sum(LEC_filt_champion()$teamdeaths)),
#           100, 0)
#   
